...
export default function SharedLayout({ children }: { children: React.ReactNode }) {
  ...
  const isShopOnly = new URLSearchParams(location.search).get('view') === '3b8c2d96';
  ...
  return (
    <div className={cn(
      ...
      {/* Main Content */}
      <main className={cn("flex-1 pb-12 px-4 lg:px-8", isShopOnly ? "pt-4" : "pt-24")}>
